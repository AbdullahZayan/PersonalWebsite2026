          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-1">
              <button
                ...
                className="relative px-4 py-2 text-cyan-300 hover:text-white transition-all duration-300 font-medium group overflow-hidden rounded-lg bg-transparent border-0 cursor-pointer"
              >
              ...
              <button
                ...
                className="relative ml-4 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white font-medium transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-cyan-500/25 border-0 overflow-hidden group px-6 py-2 rounded-md inline-flex items-center space-x-2 cursor-pointer"
              >
        ...
        {isOpen && (
          <div className="md:hidden animate-in slide-in-from-top-2 duration-300 relative z-50">
            <div className="px-2 pt-2 pb-3 space-y-2 bg-slate-800/95 backdrop-blur-md rounded-xl mt-2 border border-cyan-500/30 shadow-xl shadow-cyan-500/10">
              <button
                onClick={() => handleNavClick('home')}
                className="w-full text-left block px-4 py-3 text-cyan-300 hover:text-white hover:bg-gradient-to-r hover:from-cyan-500/20 hover:to-blue-500/20 rounded-lg font-medium transition-all duration-300 flex items-center space-x-3 bg-transparent border-0"
              >
              ...
              <button
                onClick={() => handleNavClick('about')}
                className="w-full text-left block px-4 py-3 text-cyan-300 hover:text-white hover:bg-gradient-to-r hover:from-blue-500/20 hover:to-purple-500/20 rounded-lg font-medium transition-all duration-300 flex items-center space-x-3 bg-transparent border-0"
              >
              ...
              <button
                onClick={() => handleNavClick('skills')}
                className="w-full text-left block px-4 py-3 text-cyan-300 hover:text-white hover:bg-gradient-to-r hover:from-purple-500/20 hover:to-blue-500/20 rounded-lg font-medium transition-all duration-300 flex items-center space-x-3 bg-transparent border-0"
              >
              ...
              <button
                onClick={() => handleNavClick('projects')}
                className="w-full text-left block px-4 py-3 text-cyan-300 hover:text-white hover:bg-gradient-to-r hover:from-orange-500/20 hover:to-yellow-500/20 rounded-lg font-medium transition-all duration-300 flex items-center space-x-3 bg-transparent border-0"
              >
              ...
              <button
                onClick={() => handleNavClick('certificates')}
                className="w-full text-left block px-4 py-3 text-cyan-300 hover:text-white hover:bg-gradient-to-r hover:from-green-500/20 hover:to-cyan-500/20 rounded-lg font-medium transition-all duration-300 flex items-center space-x-3 bg-transparent border-0"
              >
              ...
              <div className="px-4 py-3">
                <button
                  onClick={() => handleNavClick('contact')}
                  className="w-full bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white font-medium transition-all duration-300 hover:scale-105 flex items-center justify-center space-x-2 px-6 py-3 rounded-md border-0"
                >
